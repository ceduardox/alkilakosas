...
<div class="wcfm-container redq_rental non-variable-subscription">
    <div id="wcfm_products_manage_form_redq_rental_expander" class="wcfm-content">
        ...
        $WCFM->wcfm_fields->wcfm_generate_form_field(
            apply_filters(
                'wcfm_redq_rental_fields_general',
                array(
                    'pricing_type'         => array(
                        'label'       => __('Set Price Type', 'redq-rental'),
                        'type'        => 'select',
                        'options'     => apply_filters(
                            'wcfm_redq_rental_pricing_options',
                            array(
                        ...
                        'value'       => $pricing_type,
                        'hints'       => __('Choose a price type - this controls the schema.', 'redq-rental'),
                    ),
                    'wcfm_redq_quantity'   => array(
                        'label'       => __('Set Quantity', 'redq-rental'),
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele redq_rental',
                        'label_class' => 'wcfm_title redq_rental',
                        'value'       => $wcfm_redq_quantity,
                        'placeholder' => __('Add inventory quantity', 'redq-rental'),
                    ),
                    'perkilo_price'        => array(
                        'label'       => __('Per Kilometer Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele redq_rental',
                        'label_class' => 'wcfm_title redq_rental',
                        'value'       => $perkilo_price,
                        'hints'       => __('If you select booking layout two then for location price it will be applied', 'redq-rental'),
                        'placeholder' => __('Per Kilometer Price', 'wc-frontend-manager-ultimate'),
                    ),
                    'hourly_price'         => array(
                        'label'       => __('Hourly Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele redq_rental',
                        'label_class' => 'wcfm_title redq_rental',
                        'value'       => $hourly_price,
                    ...
                    'general_price'        => array(
                        'label'       => __('General Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_general_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_general_pricing redq_rental',
                        'value'       => $general_price,
                        'placeholder' => __('Enter price here', 'redq-rental'),
                    ),

                    'friday_price'         => array(
                        'label'       => __('Friday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[friday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $friday_price,
                        'placeholder' => __('Enter price here', 'redq-rental'),
                    ),
                    'saturday_price'       => array(
                        'label'       => __('Saturday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[saturday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                    ...
                    'sunday_price'         => array(
                        'label'       => __('Sunday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[sunday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $sunday_price,
                    ...
                    'monday_price'         => array(
                        'label'       => __('Monday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[monday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $monday_price,
                    ...
                    'tuesday_price'        => array(
                        'label'       => __('Tuesday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[tuesday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $tuesday_price,
                    ...
                    'wednesday_price'      => array(
                        'label'       => __('Wednesday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[wednesday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $wednesday_price,
                        'placeholder' => __('Enter price here', 'redq-rental'),
                    ),
                    'thursday_price'       => array(
                        'label'       => __('Thursday Price', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_daily_pricing[thursday]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_daily_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_daily_pricing redq_rental',
                        'value'       => $thursday_price,
                        'placeholder' => __('Enter price here', 'redq-rental'),
                    ),

                    'january_price'        => array(
                        'label'       => __('January Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[january]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $january_price,
                        'placeholder' => __('Enter price here', 'redq-rental'),
                    ),
                    'february_price'       => array(
                        'label'       => __('February Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[february]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                    ...
                    'march_price'          => array(
                        'label'       => __('March Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[march]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $march_price,
                    ...
                    'april_price'          => array(
                        'label'       => __('April Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[april]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $april_price,
                    ...
                    'may_price'            => array(
                        'label'       => __('May Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[may]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $may_price,
                    ...
                    'june_price'           => array(
                        'label'       => __('June Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[june]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $june_price,
                    ...
                    'july_price'           => array(
                        'label'       => __('July Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[july]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $july_price,
                    ...
                    'august_price'         => array(
                        'label'       => __('August Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[august]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $august_price,
                    ...
                    'september_price'      => array(
                        'label'       => __('September Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[september]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                    ...
                    'october_price'        => array(
                        'label'       => __('October Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[october]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                        'value'       => $october_price,
                    ...
                    'november_price'       => array(
                        'label'       => __('November Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[november]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                    ...
                    'december_price'       => array(
                        'label'       => __('December Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'name'        => 'redq_monthly_pricing[december]',
                        'type'        => 'number',
                        'class'       => 'wcfm-text rentel_pricing rental_monthly_pricing redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_monthly_pricing redq_rental',
                    ...
                    'redq_day_ranges_cost' => array(
                        'label'       => __('Days Range', 'wc-frontend-manager-ultimate'),
                        'type'        => 'multiinput',
                        'class'       => 'wcfm-text wcfm_ele rentel_pricing rental_days_range redq_rental',
                        'label_class' => 'wcfm_title rentel_pricing rental_days_range redq_rental',
                        'value'       => $redq_day_ranges_cost,
                        'options'     => array(
                            'min_days'        => array(
                                'label'       => __('Min Days', 'redq-rental'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele days_range_text redq_rental',
                                'label_class' => 'wcfm_title days_range_label redq_rental',
                            ),
                            'max_days'        => array(
                                'label'       => __('Max Days', 'redq-rental'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text days_range_text redq_rental',
                                'label_class' => 'wcfm_title days_range_label',
                            ),
                            'range_cost'      => array(
                                'label'       => __('Days Range Cost', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                                'type'        => 'text',
                                'class'       => 'wcfm-text days_range_text redq_rental',
                                'label_class' => 'wcfm_title days_range_label',
                            ),
                            'cost_applicable' => array(
                                ...
                                'class'       => 'wcfm-select days_range_text redq_rental',
                                'label_class' => 'wcfm_title days_range_label',
                            ),
                        ),
                    ),
...
<div class="wcfm-container redq_rental">
    <div id="wcfm_products_manage_form_redq_rental_discount_expander" class="wcfm-content">
        ...
        $WCFM->wcfm_fields->wcfm_generate_form_field(
            apply_filters(
                'wcfm_redq_rental_fields_discount',
                array(
                    'redq_price_discount_cost' => array(
                        'label'       => __('Discount depending on day length', 'wc-frontend-manager-ultimate'),
                        'type'        => 'multiinput',
                        'class'       => 'wcfm-text wcfm_ele redq_rental',
                        'label_class' => 'wcfm_title redq_rental',
                        'value'       => $redq_price_discount_cost,
                        'options'     => array(
                            'min_days'        => array(
                                'label'       => __('Min Days', 'redq-rental'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele rental_discount_text redq_rental',
                                'label_class' => 'wcfm_title rental_discount_label redq_rental',
                            ),
                            'max_days'        => array(
                                'label'       => __('Max Days', 'redq-rental'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text rental_discount_text redq_rental',
                                'label_class' => 'wcfm_title rental_discount_label',
                            ),
                            'discount_type'   => array(
                                ...
                                'class'       => 'wcfm-select rental_discount_text redq_rental',
                                'label_class' => 'wcfm_title rental_discount_label',
                            ),
                            'discount_amount' => array(
                                'label'       => __('Discount Amount', 'wc-frontend-manager-ultimate') . '(' . get_woocommerce_currency_symbol() . ')',
                                'type'        => 'text',
                                'class'       => 'wcfm-text rental_discount_text redq_rental',
                                'label_class' => 'wcfm_title rental_discount_label',
                            ),
...
<div class="wcfm-container redq_rental">
    <div id="wcfm_products_manage_form_redq_rental_settings_expander" class="wcfm-content">
        ...
        <div class="redq_rental_settings_block">
            ...
            $WCFM->wcfm_fields->wcfm_generate_form_field(
                apply_filters(
                    'wcfm_redq_rental_fields_display',
                    array(
                        'rnb_settings_for_display' => array(
                            ...
                            'class'       => 'wcfm-select redq_rental_settings_type redq_rental',
                            'label_class' => 'wcfm_title',
                            'hints'       => __('If you choose local setting then these following options will work, If you chooose Global Setting then  Global Settings  Of This Plugin will work', 'redq-rental'),
                            'value'       => $rnb_settings_for_display,
                        ),
                    )
                )
            );
            ...
            <div class="redq_rental_settings_block_local">
              ...
              <?php
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_redq_rental_fields_display_local',
                        array(
                            'redq_rental_local_show_pickup_date' => array(
                                'label'       => __('Show Pickup Date', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_pickup_date ,
                            ),
                            'redq_rental_local_show_pickup_time' => array(
                                'label'       => __('Show Pickup Time', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_pickup_time,
                            ),
                            'redq_rental_local_show_dropoff_date' => array(
                                'label'       => __('Show Dropoff Date', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_dropoff_date,
                            ),
                            'redq_rental_local_show_dropoff_time' => array(
                                'label'       => __('Show Dropoff Time', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_dropoff_time,
                            ),
                            'redq_rental_local_show_pricing_flip_box' => array(
                                'label'       => __('Show Pricing Flip Box', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_pricing_flip_box,
                            ),
                            'redq_rental_local_show_price_discount_on_days' => array(
                                'label'       => __('Show Price Discount', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_price_discount_on_days,
                            ),
                            'redq_rental_local_show_price_instance_payment' => array(
                                'label'       => __('Show Instance Payment', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_price_instance_payment,
                            ),
                            'redq_rental_local_show_request_quote' => array(
                                'label'       => __('Show Request Quote', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_request_quote,
                            ),
                            'redq_rental_local_show_book_now' => array(
                                'label'       => __('Show Book Now', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_show_book_now,
                            ),
                        )
                    )
                );
        ...
        <div class="redq_rental_settings_block">
            ...
            $WCFM->wcfm_fields->wcfm_generate_form_field(
                apply_filters(
                    'wcfm_redq_rental_fields_label',
                    array(
                        'rnb_settings_for_labels' => array(
            ...
            <div class="redq_rental_settings_block_local">
              <?php
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_redq_rental_fields_label_local',
                        array(
                            'redq_show_pricing_flipbox_text' => array(
                                'label'       => __('Show Pricing Text', 'redq-rental'),
                                'placeholder' => __('Show Pricing Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_show_pricing_flipbox_text,
                            ),
                            'redq_flip_pricing_plan_text'  => array(
                                'label'       => __('Show Pricing Info Heading Text', 'redq-rental'),
                                'placeholder' => __('Show Pricing Info Heading Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_flip_pricing_plan_text,
                            ),
                            'redq_pickup_location_heading_title' => array(
                                'label'       => __('Pickup Location Heading Title', 'redq-rental'),
                                'placeholder' => __('Pickup Location Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_pickup_location_heading_title,
                            ),
                            'redq_dropoff_location_heading_title' => array(
                                'label'       => __('Dropoff Location Heading Title', 'redq-rental'),
                                'placeholder' => __('Dropoff Location Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_dropoff_location_heading_title,
                            ),
                            'redq_pickup_date_heading_title' => array(
                                'label'       => __('Pickup Date Heading Title', 'redq-rental'),
                                'placeholder' => __('Pickup Date Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_pickup_date_heading_title,
                            ),
                            'redq_pickup_date_placeholder' => array(
                                'label'       => __('Pickup Date Placeholder', 'redq-rental'),
                                'placeholder' => __('Pickup Date Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_pickup_date_placeholder,
                            ),
                            'redq_pickup_time_placeholder' => array(
                                'label'       => __('Pickup Time Placeholder', 'redq-rental'),
                                'placeholder' => __('Pickup Time Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_pickup_time_placeholder,
                            ),
                            'redq_dropoff_date_heading_title' => array(
                                'label'       => __('Dropoff Date Heading Title', 'redq-rental'),
                                'placeholder' => __('Dropoff Date Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_dropoff_date_heading_title,
                            ),
                            'redq_dropoff_date_placeholder' => array(
                                'label'       => __('Drop-off Date Placeholder', 'redq-rental'),
                                'placeholder' => __('Drop-off Date Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_dropoff_date_placeholder,
                            ),
                            'redq_dropoff_time_placeholder' => array(
                                'label'       => __('Drop-off Time Placeholder', 'redq-rental'),
                                'placeholder' => __('Drop-off Time Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_dropoff_time_placeholder,
                            ),
                            'redq_rnb_cat_heading'         => array(
                                'label'       => __('Category Heading Title', 'redq-rental'),
                                'placeholder' => __('Category Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_rnb_cat_heading,
                            ),
                            'redq_resources_heading_title' => array(
                                'label'       => __('Resources Heading Title', 'redq-rental'),
                                'placeholder' => __('Resources Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_resources_heading_title,
                            ),
                            'redq_adults_heading_title'    => array(
                                'label'       => __('Adults Heading Title', 'redq-rental'),
                                'placeholder' => __('Adults Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_adults_heading_title,
                            ),
                            'redq_adults_placeholder'      => array(
                                'label'       => __('Adults Placeholder', 'redq-rental'),
                                'placeholder' => __('Adults Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_adults_placeholder,
                            ),
                            'redq_childs_heading_title'    => array(
                                'label'       => __('Childs Heading Title', 'redq-rental'),
                                'placeholder' => __('Childs Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_childs_heading_title,
                            ),
                            'redq_childs_placeholder'      => array(
                                'label'       => __('Childs Placeholder', 'redq-rental'),
                                'placeholder' => __('Childs Placeholder', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_childs_placeholder,
                            ),
                            'redq_security_deposite_heading_title' => array(
                                'label'       => __('Security Deposite Heading Title', 'redq-rental'),
                                'placeholder' => __('Security Deposite Heading Title', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_security_deposite_heading_title,
                            ),
                            'redq_discount_text_title'     => array(
                                'label'       => __('Discount Text', 'redq-rental'),
                                'placeholder' => __('Discount Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_discount_text_title,
                            ),
                            'redq_instance_pay_text_title' => array(
                                'label'       => __('Instance Payment Text', 'redq-rental'),
                                'placeholder' => __('Instance Payment Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_instance_pay_text_title,
                            ),
                            'redq_total_cost_text_title'   => array(
                                'label'       => __('Total Cost Text', 'redq-rental'),
                                'placeholder' => __('Total Cost Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_total_cost_text_title,
                            ),
                            'redq_book_now_button_text'    => array(
                                'label'       => __('Book Now Button Text', 'redq-rental'),
                                'placeholder' => __('Book Now Button Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_book_now_button_text,
                            ),
                            'redq_rfq_button_text'         => array(
                                'label'       => __('Request For Quote Button Text', 'redq-rental'),
                                'placeholder' => __('Request For Quote Button Text', 'redq-rental'),
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_rfq_button_text,
                            ),
                        )
                    )
                );
        ...
        <div class="redq_rental_settings_block">
            ...
            $WCFM->wcfm_fields->wcfm_generate_form_field(
                apply_filters(
                    'wcfm_redq_rental_fields_condition',
                    array(
                        'rnb_settings_for_conditions' => array(
                            ...
                            'label_class' => 'wcfm_title',
                            'hints'       => __('If you choose local setting then these following options will work, If you chooose Global Setting then  Global Settings  Of This Plugin will work', 'redq-rental'),
                            'value'       => $rnb_settings_for_conditions,
                        ),
                    )
                )
            );
            ...
            <div class="redq_rental_settings_block_local">
              <?php
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_redq_rental_fields_condition_local_date',
                        array(
                            'block_rental_dates' => array(
                                'label'       => __('Block Rental Dates', 'redq-rental'),
                                'hints'       => __('This will be applicable for calendar date blocks', 'redq-rental'),
                                'type'        => 'select',
                                'options'     => array(
                                ...
                                'class'       => 'wcfm-select wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $block_rental_dates,
                            ),
                            'choose_date_format' => array(
                                'label'       => __('Date Format Settings', 'redq-rental'),
                                'hints'       => __('This will be applicable for all date calendar', 'redq-rental'),
                                'type'        => 'select',
                                'options'     => array(
                                ...
                                'class'       => 'wcfm-select wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $choose_date_format,
                            ),
                            'max_time_late'      => array(
                                'label'       => __('Maximum time late (Hours)', 'redq-rental'),
                                'hints'       => __('Another day will be count if anyone being late during departure', 'redq-rental'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $max_time_late,
                            ),
                            'redq_rental_local_enable_single_day_time_based_booking' => array(
                                'label'       => __('Single Day Booking', 'redq-rental'),
                                'hints'       => __('Checked : If pickup and return date are same then it counts as 1-day. Also select this for single date. FYI : Set max time late as at least 0 for this. UnChecked : If pickup and return date are same then it counts as 0-day. Also select this for single date.', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_enable_single_day_time_based_booking,
                            ),
                        )
                    )
                );
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_redq_rental_fields_condition_local_days',
                        array(
                            'redq_max_rental_days' => array(
                                ...
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_max_rental_days,
                            ),
                            'redq_min_rental_days' => array(
                                ...
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_min_rental_days,
                            ),
                            'redq_rental_starting_block_dates' => array(
                                'label'       => __('No. of Block Days Before Booking Started', 'redq-rental'),
                                'placeholder' => __('No. of Block Days Before Booking Started', 'redq-rental'),
                                'attributes'  => array(
                                    'step' => 1,
                                    'min'  => 0,
                                ),
                                ...
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_rental_starting_block_dates,
                            ),
                            'redq_rental_post_booking_block_dates' => array(
                                'label'       => __('No. of Block Days After a Booking', 'redq-rental'),
                                'placeholder' => __('No. of Block Days After a Booking', 'redq-rental'),
                                'attributes'  => array(
                                    'step' => 1,
                                    'min'  => 0,
                                ),
                                ...
                                'class'       => 'wcfm-text wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title redq_rental',
                                'value'       => $redq_rental_post_booking_block_dates,
                            ),
                            'redq_time_interval'   => array(
                                'label'       => __('Time Inverval', 'redq-rental'),
                                'placeholder' => __('Time Inverval in mins E.X - 20', 'redq-rental'),
                                'attributes'  => array(
                                    'step' => 1,
                                    'min'  => 0,
                                    'max'  => 60,
                ...
                <select id="redq_rental_off_days" name="redq_rental_off_days[]" class="wcfm-select wcfm_ele redq_rental" multiple="multiple" style="width: 60%; margin-bottom: 10px;">
                    <option value="0" 
                    <?php
                    if ( in_array(0, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Sunday', 'redq-rental'); ?></option>
                    <option value="1" 
                    <?php
                    if ( in_array(1, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Monday', 'redq-rental'); ?></option>
                    <option value="2" 
                    <?php
                    if ( in_array(2, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Tuesday', 'redq-rental'); ?></option>
                    <option value="3" 
                    <?php
                    if ( in_array(3, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Wednesday', 'redq-rental'); ?></option>
                    <option value="4" 
                    <?php
                    if ( in_array(4, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Thursday', 'redq-rental'); ?></option>
                    <option value="5" 
                    <?php
                    if ( in_array(5, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Friday', 'redq-rental'); ?></option>
                    <option value="6" 
                    <?php
                    if ( in_array(6, $redq_rental_off_days) ) {
                        echo 'selected="selected"';
                    }
                    ?>
                    ><?php _e('Saturday', 'redq-rental'); ?></option>
                </select>
            </div>
        </div>
        ...
        <div class="redq_rental_settings_block">
            ...
            $WCFM->wcfm_fields->wcfm_generate_form_field(
                apply_filters(
                    'wcfm_redq_rental_fields_validation',
                    array(
                        'rnb_settings_for_validations' => array(
                            ...
                            'label_class' => 'wcfm_title',
                            'hints'       => __('If you choose local setting then these following options will work, If you chooose Global Setting then  Global Settings  Of This Plugin will work', 'redq-rental'),
                            'value'       => $rnb_settings_for_validations,
                        ),
                    )
                )
            );
            ...
            <div class="redq_rental_settings_block_local">
              <?php
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_redq_rental_fields_validation_local_location',
                        array(
                            'redq_rental_local_required_pickup_location' => array(
                                'label'       => __('Required Pickup Location', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_required_pickup_location,
                            ),
                            'redq_rental_local_required_return_location' => array(
                                'label'       => __('Required Return Location', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_required_return_location,
                            ),
                            'redq_rental_local_required_person' => array(
                                'label'       => __('Required Person', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_local_required_person,
                            ),
                            'redq_rental_required_local_pickup_time' => array(
                                'label'       => __('Required Pickup Time', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_required_local_pickup_time,
                            ),
                            'redq_rental_required_local_return_time' => array(
                                'label'       => __('Required Return Time', 'redq-rental'),
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele redq_rental',
                                'label_class' => 'wcfm_title checkbox_title redq_rental',
                                'value'       => 'open',
                                'dfvalue'     => $redq_rental_required_local_return_time,
                            ),
                        )
                    )
                );
        ...
        <h2><?php _e('Daily Basis Openning & Closing Time', 'wc-frontend-manager-ultimate'); ?></h2><div class="wcfm_clearfix"></div>
        <?php
        $WCFM->wcfm_fields->wcfm_generate_form_field(
            apply_filters(
                'wcfm_redq_rental_fields_daily_times',
                array(
                    'redq_rental_fri_min_time'  => array(
                        'label'       => __('Friday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_fri_min_time,
                    ),
                    'redq_rental_fri_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_fri_max_time,
                    ),
                    'redq_rental_sat_min_time'  => array(
                        'label'       => __('Saturday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_sat_min_time,
                    ),
                    'redq_rental_sat_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_sat_max_time,
                    ),
                    'redq_rental_sun_min_time'  => array(
                        'label'       => __('Sunday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_sun_min_time,
                    ),
                    'redq_rental_sun_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_sun_max_time,
                    ),
                    'redq_rental_mon_min_time'  => array(
                        'label'       => __('Monday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_mon_min_time,
                    ),
                    'redq_rental_mon_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_mon_max_time,
                    ),
                    'redq_rental_thu_min_time'  => array(
                        'label'       => __('Tuesday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_thu_min_time,
                    ),
                    'redq_rental_thu_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_thu_max_time,
                    ),
                    'redq_rental_wed_min_time'  => array(
                        'label'       => __('Wednesday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_wed_min_time,
                    ),
                    'redq_rental_wed_max_time'  => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_wed_max_time,
                    ),
                    'redq_rental_thur_min_time' => array(
                        'label'       => __('Thursday', 'redq-rental'),
                        'placeholder' => __('Min Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'label_class' => 'wcfm_title opening_closing_label redq_rental',
                        'value'       => $redq_rental_thur_min_time,
                    ),
                    'redq_rental_thur_max_time' => array(
                        'placeholder' => __('Max Time', 'redq-rental'),
                        'type'        => 'time',
                        'class'       => 'wcfm-text wcfm_ele opening_closing_text redq_rental',
                        'value'       => $redq_rental_thur_max_time,
                    ),
                )
            )
        );
