            ...
            <div id="rnbSmartwizard">
                ...
                <section class="rnb-step-content-wrapper">
                    <div id="rnb-step-2" class="">
                        ...
                        <?php
                        //$dropoff_location = $extra_location_labels['dropoff_location'];
                        /*echo "<br>".$product_id;
                        echo "<br>".$reqID = $redq_product_inventory[0];

                        echo "<pre>";
                         //print_r($redq_product_inventory);
                        
                        foreach ($inventories as $inventory) {
                            // Imprimir los metadatos de cada inventario
                            print_r(get_post_meta($reqID));
                        }
                        ...
                        foreach ($taxonomies as $taxonomy) {
                            $terms = wp_get_object_terms($redq_product_inventory[0], $taxonomy);
                        
                            if (!empty($terms)) {
                                echo "Taxonomía: $taxonomy\n";
                        ...
                        <div class="rnb-google-location-map-area">
                            <div class="rnb-autocomplete-input-group">
                                ...
                                <input type="text" name="pickup_location" data-latlng="-17.3940591|-66.1638756" class="rnb-pickup-location" id="rnb-origin-autocomplete" />

                                <input type="text" name="dropoff_location" data-latlng="-17.3940591|-66.1638756" class="rnb-dropoff-location" id="rnb-destination-autocomplete" />
                            </div>
                ...
                <section class="rnb-step-content-wrapper">
                    <div id="rnb-step-3" class="">
                        <?php if (!empty($extra_datetime_labels['date_inner_heading']) || !empty($extra_datetime_labels['date_inner_desc'])) { ?>
                            ...
                            <header class="date-error-message section-title">
                                <h4 class="date-error-message-text">
                ...
                <?php endif; ?>
                <!-- End #6th Step -->
                <?php do_action('rnb_before_booking_summary', $product_id, $inventory_id); ?>
