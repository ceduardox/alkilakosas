        ...
        switch ($type) {
            ...
            case 'validations':
                if ($validations_settings === 'local') {
                    ...
                    $default['tue_min']  = '00:00';
                    $default['tue_max']  = '24:00';
                    ...
                    foreach ($default as $key => $value) {
                        if(empty($data[$key])) $data[$key] = $default[$key];
                    }
                ...
                $time_avail['tue']['min'] = $tue_min;
                $time_avail['tue']['max'] = $tue_max;
        ...
        if (isset($holidays_ara) && !empty($holidays_ara)) :
            foreach ($holidays_ara as $key => $value) {
                ...
                if (strpos($value, "to")) {
                    ...
                    $holidays[] = manage_all_dates($value, $value, 'no', $output_format, '+1 day');
                }
            }
        endif;
