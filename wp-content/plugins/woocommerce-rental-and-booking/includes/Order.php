...
class Order
{
    ...
    public function rnb_order_price_details()
    {
        ...
        $deposit_markup = '<tr class="deposit cart-subtotal">
                                <th class="row-subtotal text-right" colspan="3">' . esc_html__('Deposit', 'redq-rental') . '</th>
                                <td class="row-subtotal text-right"  colspan="2" data-title="' . esc_attr__("Deposit", "redq-rental") . '">' . wc_price($deposit) . '</td>
                            </tr>';
