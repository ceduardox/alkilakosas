...
$order_type_object = get_post_type_object( OrderUtil::get_order_type( $order_id ) );
		...
		<div class="wcfm-container">
			<div id="orders_details_general_expander" class="wcfm-content">
				...
				<p class="form-field form-field-wide"><label for="order_date"><?php _e( 'Order date:', 'wc-frontend-manager' ) ?></label>
					<?php echo date_i18n( wc_date_format() . ' @' . wc_time_format(), strtotime( $order->get_date_created() ) ); ?>
				</p>
											...
											<?php
												...
												echo '<div class="address">';
													...
													if ( apply_filters( 'woocommerce_enable_order_notes_field', 'yes' == get_option( 'woocommerce_enable_order_comments', 'yes' ) ) && $order->get_customer_note() ) {
														echo '<p><strong>' . __( 'Customer Provided Note', 'wc-frontend-manager' ) . ':</strong> ' . nl2br( esc_html( $order->get_customer_note() ) ) . '</p>';
													}
