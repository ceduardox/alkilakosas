...
jQuery(document).ready(function ($) {
	...
	$('.bulk_action_checkbox_all').click(function() {
		...
		$('.bulk_action_checkbox_all, .bulk_action_checkbox_single').attr( 'checked', $(this).is(':checked') );

		if( $(this).is(':checked') ) {
			$('.bulk_action_checkbox_all, .bulk_action_checkbox_single').attr( 'checked', true );
		}	else {
			$('.bulk_action_checkbox_all, .bulk_action_checkbox_single').attr( 'checked', false );
		}
	});
